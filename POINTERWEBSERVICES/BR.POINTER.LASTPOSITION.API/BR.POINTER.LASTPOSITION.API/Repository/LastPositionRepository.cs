    ...
    public class LastPositionRepository
    {
        ...
        public static async Task<APIReturnModel> GetAddress(AddressInputModel arg)
        {
            ...
            try
            {
                ...
                {
                    DynamicParameters parameters = new DynamicParameters();
                    parameters.Add("Lat", arg.Lat, direction: ParameterDirection.Input, dbType: DbType.Int64);
                    parameters.Add("Lng", arg.Lng, direction: ParameterDirection.Input, dbType: DbType.Int64);
                    parameters.Add("Raio", arg.R, direction: ParameterDirection.Input, dbType: DbType.Int32);
